...
**Виджеты** – информационные блоки, в которых в зависимости от их назначения и настроек могут отображаться Задачи, Статус задач, доступные Действия, Документы и т.п. Подробно о виджетах.
...
Элементы, отображаемые в меню, могут быть гибко настроены.
...
Функционал журналов в системе позволяет хранить и систематизировать информацию, созданную в системе.
...
Карточка - страница объекта (заявки, документа, процесса и т.п.) Представляет собой дашборд с определенным для этого объекта набором виджетов.
